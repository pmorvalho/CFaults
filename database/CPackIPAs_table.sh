#!/usr/bin/env bash
#Title			: get_CPackIPAs_table.sh
#Usage			: bash get_CPackIPAs_table.sh
#Author			: pmorvalho
#Date			: January 29, 2024
#Description		: Prints a SQL script to populate table C-Pack-IPAs.
#Notes			: 
# (C) Copyright 2024 Pedro Orvalho.
#==============================================================================

echo '''DROP TABLE IF EXISTS CPackIPAs;
CREATE TABLE CPackIPAs (
